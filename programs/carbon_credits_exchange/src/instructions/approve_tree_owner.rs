...
pub fn approve_tree_owner(
    ...
    let computed_carbon_credits = params.no_of_trees * single_tree_to_carbon_credits_mapping as u32;

    tree_owner.approval_status = true;
    tree_owner.no_of_trees = params.no_of_trees;

    carbon_credits_configs.total_no_of_trees_planted =
        total_no_of_trees_planted + params.no_of_trees;
